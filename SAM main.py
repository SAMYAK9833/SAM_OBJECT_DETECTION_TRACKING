...
st.set_page_config(page_title=" SAM Object Detection & Tracking", layout="wide")
st.title("SAM Object Detection & Tracking (YOLOv8 + Deep SORT)")
...
st.sidebar.markdown("<p style='text-align: center; font-size: 14px;'>Developed by <b>Samyak Vaidya</b></p>", unsafe_allow_html=True)
